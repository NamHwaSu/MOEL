...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyBuildingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FindBuildingButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
        ...
        FindBuildingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyBuildingButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute(){
            target = "http://121.133.44.212/NoticeList.php";
        }
